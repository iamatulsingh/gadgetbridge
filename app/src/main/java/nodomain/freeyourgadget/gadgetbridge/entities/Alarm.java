...
public class Alarm implements nodomain.freeyourgadget.gadgetbridge.model.Alarm {
    ...
    public Alarm(long deviceId, long userId, int position, boolean enabled, boolean smartWakeup, boolean snooze, int repetition, int hour, int minute, boolean unused) {
